...
public class SrsEncoder {
    ...
    public static final int VBITRATE = 600 * 1000;  // 500kbps
    ...
    public static final int ABITRATE = 64 * 1000;  // 32kbps
...
//                    rotateYUV420SemiPlannerFrame(mFlippedFrameBuffer, mRotatedFrameBuffer, vCropHeight, vCropWidth);
                    NV21ToNV12(data, mRotatedFrameBuffer, 360, 640);
//                    mRotatedFrameBuffer = data;
                    break;
                default:
                    throw new IllegalStateException("Unsupported color format!");
            }
